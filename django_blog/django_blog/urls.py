...
urlpatterns = [
    ...
    path('', include('blog.urls')), # Home page of project
    path('store/', include('store.urls')),
    path('register/', user_views.register, name="register"), # Another way to add urls
    ...
    path('password_reset_complete/', auth_views.PasswordResetView.as_view(template_name="user/password_reset_complete.html")
